...
resource "null_resource" "remote-exec" {
 ...
 // copy our NGINX configuration over
  ...
  depends_on = ["google_sql_database_instance.master", "vault_auth_backend.approle", "vault_mount.pki", "vault_mount.gcp", "vault_mount.kv", "vault_auth_backend.userpass", "vault_auth_backend.gcp", "module.k8s.kubernetes_service_account.vault-auth"]
}
